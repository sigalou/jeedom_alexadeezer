...
$plugin = plugin::byId('alexadeezer');
// Charger le javascript
sendVarToJS('eqType', $plugin->getId());
//sendVarToJS('serveurtest', 'lionel dans alexadeezer.php');
...
<div class="row row-overflow">
  ...
  <div class="col-xs-12 eqLogicThumbnailDisplay">
	...
	<legend><i class="fas fa-table"></i> {{Mes Deezer Players}}</legend>
...
?>		
	...
	if (config::byKey('utilisateurExperimente', 'alexadeezer',0)!="0")
	{	
	?>
